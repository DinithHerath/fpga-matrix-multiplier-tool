...
class MatrixAWidget extends StatelessWidget {
  MatrixAWidget({Key key}) : super(key: key);

  final Map<int, int> _mat = Map();
  final GlobalKey<FormState> _formKeyA = new GlobalKey<FormState>();
                      ...
                      children: [
                        for (var j = 0; j < cCount; j++)
                          Container(
                            ...
                            child: Center(
                              child: TextFormField(
                                initialValue: state.matA == null || state.matA.isEmpty ? "0" : state.matA[i * cCount + j].toString(),
                  ...
                  TextButton(
                    onPressed: () {
                      if (_formKeyA.currentState.validate()) {
                        ...
                        homeBloc.add(FillMatricesEvent(true, _mat));
                      }
                    },
